...
\usepackage{geometry}\geometry{top=4cm,bottom=3cm,left=3cm,right=3cm}
...
\titleformat{\subsection}[hang]{\color{astral!50!black}\large\bfseries\filcenter}{\S\thesection.}{1em}{}
...
\newtheorem{deff}[teo]{\color{orange!50!black} Definición}{\smallskip}
\newtheorem{ej}[teo]{\color{orange!50!black} Ejemplo}{\smallskip}

% Remarks
\theoremstyle{remark}
\newtheorem{obs}[teo]{\color{yellow!40!rojo} Observación}{\smallskip}
