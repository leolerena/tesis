...
Separamos en casos dependiendo cómo es el grafo $Y$.
	\begin{enumerate}
		...
		En este caso el grupo $F(\cG)$ resulta ser isomorfo a la extensión HNN $G_P^{\ast G_y}$.
		Por ser $(c, \mu)$ una palabra reducida vemos que esta condición en este caso coincide con la definición inicial de una palabra reducida para una extensión HNN.		
