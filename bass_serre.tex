...
\todo{Dar la noción de sucesión reducida. Explicar la diferencia con forma normal, que ésta es una elección de una sucesión reducida (viene de una estrategia en particular).}
...
Separamos en casos dependiendo cómo es el grafo $Y$.
	\begin{enumerate}
		...
		\todo{Escribir detalladamente esta cuenta en el grupo amalgamado.}
