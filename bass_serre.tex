...
Para probar que es válida la fórmula de \textbf{(b)} notemos que..

Finalmente la definición \textbf{(c)} es válida porque usando la validez de la anterior y reemplazando $y$ por $\ol y$ obtenemos este resultado.
