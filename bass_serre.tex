...
\todo[]{Agregar más historia acá. Quizás que es un resultado originalmente de Schreier.}
...
\begin{proof}
	Si $G$ es libre  y generado por un conjunto finito $S$ entonces $Cay(G,S)$ es un árbol por el resultado \ref{}.
	Por la proposición \ref{} tenemos que $G$ actúa libremente sobre su grafo de Cayley y sin invertir aristas.
...
\begin{proof}
	...
	Luego definimos $\alpha:G \to S(X)$ de la siguiente manera si $g_{l} g_{i} = g_{h}$
	\[
