...
La mayoría de las construcciones de esta sección siguen la exposición de \cite{serre2002trees} aunque la notación no es exactamente la misma sino que es la utilizada en los trabajos \ref{} y \ref{}.
...
\subsection{Definiciones básicas.}
	...
	\begin{itemize}
		\item Al conjunto $V(Y)$ lo llamaremos los vértices.
		\item Al conjunto $E(Y)$ las aristas del grafo.
	\end{itemize}
	...
	Una camino va a ser una sucesión de aristas 
	\[
