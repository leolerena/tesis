...
\begin{deff}
	...
	Para cada arista $y \in E$ tendremos unas asignaciones $s(y) = P \in V, t(y) = Q \in V$ que determinan a la arista.
	A su vez para cada $y \in E$ existe una única arista $\overline y \in E$ que cumple que $s(\ol y) = Q$ y que $t(\ol y) = P$. 
\end{deff}
