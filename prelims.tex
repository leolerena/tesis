...
En la primer sección \ref{secc_grupos_vl} introduciremos los grupos virtualmente libres y probaremos algunos resultados estándares de teoría de grupos sobre grupos finitamente generados. 
La observación \ref{obs_presentacion_vl} será de gran utilidad en los siguientes capítulos para tener una buena presentación para el problema de la palabra para los grupos virtualmente libres.

En la segunda sección \ref{secc_tlen} introduciremos ágilmente resultados estándares de la teoría de lenguajes junto con algunos ejemplos para ilustrar todas estas definiciones.
...
\section{Grupos virtualmente libres.}\label{secc_grupos_vl}
...
\begin{deff}
	Un grupo $G$ finitamente generado es \emph{virtualmente libre} si existe un subgrupo libre $F$ tal que $(G:F) < \infty$.
\end{deff}
Con esto podemos probar estos resultados elementales de grupos \vl.


\todo[inline]{Sacar enumerate de la demostración.}
