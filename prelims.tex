...
\begin{deff}
	Dado $\Sigma = \{a,b\}$ definimos el \emph{lenguaje de los palíndromos sobre $\Sigma$} de la siguiente manera
	\[
...
Esto nos define una relación sobre $Q \times \Sigma^*$ tal que su clausura transitiva y reflexiva la denotaremos $\vdash^*$.
