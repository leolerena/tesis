...
\newcommand*{\teocajitados}[2]{\begin{tcolorbox}[colback=rojo!5!white,colframe=rojo!75!black,title=Teorema (#1)]
  #2
  \end{tcolorbox}}
...
\newcommand*{\lemacajitados}[2]{\begin{tcolorbox}[colback=rojo!5!white,colframe=rojo!75!black,title=Lema #1]
  #2
\end{tcolorbox}}    
...
\newcommand{\frameg}[2]{\begin{frame}[fragile]{#1}
		#2
\end{frame}}    