...
\begin{document}
		...
		tiene un subgrupo libre $F$ tal que $[G:F] < \infty$.}
			...
			\textbf{Ejemplos}.
				\begin{itemize}
					...
					\item \pause Los grupos libres finitamente generados.
	...
	\begin{frame}[fragile]{Grafos como espacios métricos.}
		...
		\pause 
		\defcajita{Sea $\Gamma$ un grafo conexo luego dado un conjunto $C \subseteq V(\Gamma)$ definimos el \textbf{borde de vértices} de $C$ como
		\[
	...
	\begin{frame}[fragile]{Forma normal de Chomsky.}
		\defcajita{
			Una gramática $\gramatica$ independiente de contexto está en \textbf{forma normal de Chomsky} si las producciones son de alguna de estas tres formas: 
			\begin{enumerate}
	...
	\begin{frame}[fragile]{Un lema para forma normal de Chomsky.}
		\lemacajita{
		Sea $\gramatica$ una gramática independiente de contexto en forma normal de Chomsky, $uvw \in L(\cG)$ y $\deri = S \tto uvw$ una derivación.
		Entonces existe un vértice en el árbol de derivación $T(\deri)$ que es el más joven entre aquellos con la propiedad de producir una palabra que contiene a $v$.
		}
		\pause 
		...
		\begin{columns}
			...
			\begin{column}{0.4 \textwidth}
				...
				Entonces el vértice con etiqueta \alert{T} es el vértice más joven que produce una palabra que contiene a \blue{$v$}.		
			\end{column}
	...
	\begin{frame}[fragile]{Lema 3.}
		\lemacajitados{3}{Sea $\gramatica$ una gramática independiente de contexto en forma normal de Chomsky, $uvw \in L(\cG)$ de modo que $|v| \ge 2$ y $\deri = S \tto uvw$ una derivación. 
					...
					\begin{adjustbox}{width = 
						...
						\begin{tikzpicture}[font=\sffamily]
								...
								% \draw [decorate,decoration={brace,amplitude=5pt,mirror,raise=4ex}]
  											% (-2,2) -- (9,-9) node[midway,yshift=-8em]{Konvergenzbereich};
						\end{tikzpicture}
					\end{adjustbox}
				\end{center}
			\end{column}
					...
					\begin{center}
						\begin{adjustbox}{width = 
							...
							\begin{tikzpicture}[font=\sffamily]
									...
									%\draw [very thick, cadmiumred, label= $B_{n}(1)$] (-3,2.25)[bend left=10]  to (10,2.5);
									%\node[label=right:{\huge{\textcolor{cadmiumred}{$B_{n}(1)$}}}] at (-3,3) {};
									\draw[ultra thick,blue] (C) to[bend right = 6.25] (x);
									\node[label=right:{\LARGE{\textcolor{blue}{$u'$}}}] at (3,-3) {};
							\end{tikzpicture}
						\end{adjustbox}
					...
					\begin{center}
						\begin{adjustbox}{width = 
							...
							\begin{tikzpicture}[font=\sffamily]
									...
									%\draw [very thick, blue, label= $B_{n}(1)$] (-3,2.25)[bend left=10]  to (10,2.5);
									%\node[label=right:{\huge{\textcolor{blue}{$B_{n}(1)$}}}] at (-3,3) {};
									\draw[ultra thick,blue] (x) to[bend right = 3.25] (A);
									\draw[ultra thick,blue] (A) to[bend left = 16.25] (y);
									\node[label=right:{\LARGE{\textcolor{blue}{$v'$}}}] at (3,4) {};
							\end{tikzpicture}
						\end{adjustbox}
					\end{center}
				\end{column}
					...
					\begin{center}
						\begin{adjustbox}{width = 
							...
							\begin{tikzpicture}[font=\sffamily]
									...
									\node[label=right:{\LARGE{\textcolor{blue}{$v''$}}}] at (8,1) {};
							\end{tikzpicture}
						\end{adjustbox}
					\end{center}
				\end{column}
					...
					\begin{center}
						\begin{adjustbox}{width = 
							...
							\begin{tikzpicture}[font=\sffamily]
									...
									%\draw [very thick, blue, label= $B_{n}(1)$] (-3,2.25)[bend left=10]  to (10,2.5);
									%\node[label=right:{\huge{\textcolor{blue}{$B_{n}(1)$}}}] at (-3,3) {};
									\node[label=right:{\LARGE{\textcolor{blue}{$w'$}}}] at (8,-6) {};
									\draw[ultra thick,blue] (z) to[bend right = 4.55] (C);
							\end{tikzpicture}
						\end{adjustbox}
					\end{center}
				\end{column}
	...
	\begin{frame}[fragile]{Teorema de Muller--Schupp.}
		\begin{columns}
					...
					\begin{center}
						\begin{adjustbox}{width = 
							...
							\begin{tikzpicture}[font=\sffamily]
									...
									\draw[ultra thick,blue] (A) to[bend left = 16.25] (y);
									\node[label=left: \huge \color{cadmiumred}$k_{B}$] at (barycentric cs:x=1,y=1) {};
									\node[label=right:{\LARGE{\textcolor{blue}{$v'$}}}] at (3,4) {};
									}
									\onslide<3>{
									...
									\draw[ultra thick,blue] (y) to[bend left = 6.25] (B);
									\node[label=right:\huge \color{cadmiumred}$k_{C}$] at (barycentric cs:x=0.5,y=0.9,z=0.8) {};
									\node[label=right:{\LARGE{\textcolor{blue}{$v''$}}}] at (8,1) {};
									}
									...
									\node[label=below:\huge \color{cadmiumred}$k_{A}$] at (barycentric cs:x=1,z=1) {};
									\node[label=right:{\LARGE{\textcolor{blue}{$v'v''$}}}] at (3,4) {};
									}
							\end{tikzpicture}
						\end{adjustbox}
					\end{center}
			...
			\begin{column}{0.35 \textwidth}
				...
				\begin{itemize}
					\item \onslide<3->{Tenemos que $d(x,y) \le k_{B} \le k$.}
					\item \onslide<4->{Similarmente $d(y,z) \le k_{C} \le k$.}
					\item \onslide<5->{Similarmente $d(x,z) \le k_{A} \le k$.}
				\end{itemize}
			\end{column}
		\end{columns}
	\end{frame}
				...
				\begin{center}
					\begin{adjustbox}{width = 
						...
						\begin{tikzpicture}[font=\sffamily]
								...
								\draw[line width = 0.8pt, cadmiumred] (z) to (x) ;
								\draw[line width = 0.8pt, cadmiumred] (y) to (x) ;
								\node[label=left: \huge \textcolor{cadmiumred}k] at (barycentric cs:x=1,y=1) {};
								\node[label=right:\huge \textcolor{cadmiumred}k] at (barycentric cs:y=0.9,z=0.8) {};
								\node[label=below:\huge \textcolor{cadmiumred}k] at (barycentric cs:x=1,z=1) {};
								\node[label=right:{\huge{$\alpha$}}] at (2,-2) {};
								\node[label=right:{\huge{$\tau$}}] at (2.4,3.67) {};
								\node[label=right:{\huge{$\gamma$}}] at (7.5,-1.5) {};
