...
\begin{document}
	...
	\begin{frame}[fragile]{Lema 1.}
		...
		$\Gamma$ el grafo de Cayley y $(T,f)$ una descomposición en un árbol para $\Gamma$.
	...
	\begin{frame}[fragile]{Teorema de Muller--Schupp.}
		\teocajita{Sea $G$ un grupo finitamente generado por $X$ luego si $\WP{G}{X}$ es un lenguaje independiente de contexto entonces el grafo de Cayley $\Gamma$ tiene treewidth finito.}
		\pause 
		\textbf{Idea de la demostración.}
		\begin{itemize}
