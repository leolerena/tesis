...
\end{obs}
	...
	\begin{lema}\label{lema_MuSc_invariante}
	 Sea $w \in W^*$ tal que $ w = uv $ entonces si consideramos una configuración de la pinta
		\[
			(v, (t_{k},1,1), s)
		\]
		vale que $u = t_{k}s$.
...
\begin{proof}
	Para probar que es \ic vamos a probar que el \APD de Muller--Schupp $\cal M$ cumple que ${\cal L(M)}= \text{WP}(G,W)$.
