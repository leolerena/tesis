...
De esta manera $\{ a^k b : \ k \ge 0  \}$ resulta ser un lenguaje regular.


\begin{deff}
	Un \blue{autómata finito} es una tupla ${\cal M} = (Q,\{q_0\},\Sigma,\delta,F)$ donde:
	\begin{itemize}
...
\begin{ej}
	%Poner ejemplo de una gramática en forma de Chomsky y aclarar lo que uso en la sección de treewidth de como es su forma.
\end{ej}
...
\begin{deff}
	Un \blue{autómata de pila finito no determinístico} es una tupla ${\cal M } = (Q, \Sigma, Z, \delta, q_0, F, Z_0)$ donde:
	\begin{itemize}
...
En esta sección vamos a considerar la clase de lenguajes \ic que denotaremos \textsc{LIC}.
...
Como corolario de esta proposición y de saber que los lenguajes \ic podemos tomar la siguiente definición.
\medskip
\begin{deff}
