...
%		\draw[step=2.0,black,thin] (0,0) grid (4,4);
	...
	\end{tikzpicture}
	\caption{El grafo $\Gamma$ tiene tres ends. Estos son $\textcolor{cadmiumred}{\omega_{1}}, \textcolor{carrotorange}{\omega_{2}}$ y $\textcolor{applegreen}{\omega_{3}}$.}
\end{figure}
...
\end{lema}
\begin{proof}
	\todo{Desarmar esta demo en 2 o 3 lemas.}
...
\begin{proof}
	...
	Elegimos $k$ de manera que ${\cal U} \subset B_{k}(v)$.
	...
	y esto implica que $ \bigcap_{u \in U} G_{u}$ está en $\cG$ y por lo tanto $G_{\cal U}$ es virtualmente $\cG$.
\end{proof}
