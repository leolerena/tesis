...
\begin{lema}
	...
	Para todo $\gamma$ camino infinito simple, todo $v \in V(\Gamma)$ y todo $n \in \NN$ debe existir un $k-$corte $D$ que cumple las siguientes propiedades, $d(v,\ol D) \ge n, v \in D, |\ol D \cap \gamma| = \infty$. 
\end{lema}
...
\begin{proof}
	...
	Repetimos este procedimiento por cada vértice de la componente conexa de $T \setminus t$.
	...
	Si elegimos $l \in \NN$ suficientemente grande podemos garantizar que $X_{t_l} \cap B_n(v_0) = \emptyset$.
	...
	Ahora vamos a buscar el corte $D$, para eso vamos a necesitar un conjunto conexo con borde finito.
	...
	Ambos conjuntos son no vacíos porque $C_{t_l, \gamma}$ es infinito y es un subgrafo de $\ol D$.
	...
	En este caso notemos que $v \in _{t_l}$ caso contrario tendríamos que $v \in C_{t_l, \gamma}$ dado que esta es una de las componentes conexas de $X \setminus X_{t_l}$.
