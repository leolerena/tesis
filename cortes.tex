...
\begin{lema}\label{lema_esquinas_caminos}
	...
	\begin{enumerate}
		\item$C \in {\cal C}(\beta)$ y $D \in {\cal C}(\alpha)$.
		
		\item Existen $K_{1}, K_{2}$ esquinas opuestas tales que
		\[
		|K_{1} \cap \alpha| = |K_{2} \cap \beta | = \infty. 
		\]
...
\begin{proof}
	...
	El primer caso que consideramos es el que tenemos dos esquinas $K_{1}, K_{2}$ tales que $|K_{1} \cap \alpha| = |\ol{K_{1}} \cap \alpha| = \infty$ y $|K_{2} \cap \alpha| = |\ol{K_{2}} \cap \alpha|=\infty$.
	Esto nos dice que $C \in {\cal C}(\beta)$ y que $D \in {\cal C}(\alpha)$.
	En cualquier otro caso obtenemos que existen $K_{1},K_{2}$ esquinas opuestas de manera que $|K_{1} \cap \alpha| = |K_{2} \cap \beta | = \infty$.
...
\end{teo}
\begin{proof}
	\todo[]{Reescribir esta primera parte siguiendo el lema.}
	...
	\todo{Fletar parte de la componente conexa y escribir bien el argumento de la conexión.}
	...
	\todo{En realidad estamos viendo que $E,E'$ son cortes minimales. Escribir bien.}
