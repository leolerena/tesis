...
\TODO{Escribir una prop más general para ver que un L aceptado por un APD es aceptado por un k-APD y viceversa. En definitiva necesito el caso de $L({\cal M}, \gamma)$.}
\begin{prop}
