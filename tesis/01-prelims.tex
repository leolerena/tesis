...
\TODO{Escribir sobre árboles de derivación y traducir bien los resultados que necesito.}
...
\TODO{Terminar de revisar esta sección y pasarla al siguiente capítulo.}
\begin{deff}
	...
	% Dados conjuntos $V$ y $E$ un \emph{grafo dirigido según Serre} es un par ordenado $Y= (V,E)$ junto con funciones
	% $s:E \to V$, $t:E \to V$ y 
