...
\end{proof}
	...
	\begin{proof}
		...
		% Para esto definimos el siguiente procedimiento que dada $w \in (W \cup A^{-1})^{*}$ una palabra que representa a $g'$ la modificamos para obtener otra palabra $w' \in (W \cup A^{-1})^{-1}$ que representa a $g'$.
		% Esta procedimiento sobre palabras en $W \cup A^{-1}$ lo representamos de la siguiente manera: $w \to w'$.
