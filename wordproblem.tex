...
\begin{deff}
Un grupo $G$ es \blue{virtualmente libre} si existe un subgrupo $F$ libre tal que el índice es finito.
\end{deff}
...
\begin{ej}
	...
	Si tomamos los siguientes generadores $\Sigma = \{ a,b,c \}$ tal que ...
	Usando el lema del pumping \ref{} podemos ver que este lenguaje no es independiente de contexto.
	Para eso...
\end{ej}
