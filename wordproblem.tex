...
\begin{ej} Consideremos los siguientes ejemplos.	
	\begin{enumerate}[E1.]
		...
		\begin{array}{ll}
			(1 , 1, u )  &\ \text{si} \ w = 1  \\
			(w',1,y_i \cdot y_ju') &\ \text{si} \ w = y_iw', u = y_jw'  \\
		\end{array}
		\right.
		\]
		donde al apilar hacemos la multiplicación $y_i \cdot y_j$ en el grupo libre $F$.
...
\begin{teo} [Muller - Schupp 1985] \cite{muller1985theory}
