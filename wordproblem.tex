...
\begin{ej}
	Sea $\mathbb F_2$ el grupo libre en dos generadores $a,b$. Su grafo de Cayley para estos generadores tiene la siguiente pinta,
	\bigskip
...
\begin{deff}\label{desc-arbol}
	...
	\begin{enumerate}
		\item Para todo vértice $v \in V(X)$ debe existir $t \in V(T)$ tal que $x \in X_t$. 
		\item Para toda arista $e$ entre dos vértices $v,w \in V(X)$ debe existir $t \in V(T)$ tal que $v,w \in X_t$.
...
\begin{ej}
	...
	De esta manera si $Y$ es el siguiente segmento... \red{agregar gráfico}
	entonces
	\[
