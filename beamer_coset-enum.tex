...
\begin{frame}[fragile]{Merge.}
	...
	\pause
	\begin{codebox}
		\Procname{$\proc{merge}( \Co : \text{Tabla de cosets}, \textbf{i} : \text{coset}, \textbf{j} : \text{coset}) : (\Co' : \text{Tabla de cosets}, q : \text{lista de cosets})$}
...
\begin{frame}[fragile]{Coincidencia.}
	...
	\pause
	\begin{codebox}\Procname{$\proc{procesarLetra}(\Co : \text{Tabla de cosets}, \textbf{i} : \In, x : A ) : (\Co' : \text{Tabla de cosets}, q: \text{lista de cosets})$}
		\li \textbf{Si} \edeff($\Co, \textbf{i}, x$)
